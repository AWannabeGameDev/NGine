...
public : 
	...
	TileLayer(const tmx::TileLayer& layer, std::vector<Tileset>& tilesets, std::string_view name, Renderer& render, float tileLength, unsigned int tileCountX, unsigned int tileCountY, float layerDepth);
